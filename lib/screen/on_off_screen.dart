        ...
        children: [
                ...
                IconCircleButton(
                  ...
                  onClick: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ParameterSettingScreen(),
                        ));
                  },
                  size: 24,
                ),
          ...
          FlutterSwitch(
            ...
            onToggle: (bool value) {
              ...
              if (value)
                _statusBloc.add(StatusOnEvent());
              else
                _statusBloc.add(StatusOffEvent());
            },
          ),
          SizedBox(
            height: 8,
          ...
          Row(
            ...
            children: [
              Text(
                "off",
                style: TextStyle(fontSize: 10, color: Colors.white.withOpacity(!onOffValue ? 1 : 0.3)),
              ),
              SizedBox(
                width: 4,
              ),
